...
-- For subsequent days (if data not reset)
INSERT INTO task_details(start_time, end_time, duration, description, is_active, project_id, task_id, category_id) VALUES('06:15:00', '07:00:00', '00:45:00', 'Conducting analysis of reusing Angular component for user form input and emailing back client', 1, 1, ?, 1);
INSERT INTO task_details(start_time, end_time, duration, description, is_active, project_id, task_id, category_id) VALUES('07:15:00', '10:30:00', '03:45:00', 'Implemeting user form input and hooking up with back-end components and fixing misc issues along the way', 1, 1, ?, 2);
INSERT INTO task_details(start_time, end_time, duration, description, is_active, project_id, task_id, category_id) VALUES('10:31:00', '10:45:00', '00:15:00', 'Stand up - Update on previous Angular research and implementation of user input form', 1, 1, ?, 1);
INSERT INTO task_details(start_time, end_time, duration, description, is_active, project_id, task_id, category_id) VALUES('10:46:00', '11:46:00', '01:00:00', 'Testing of component and adding unit tests', 1, 1, ?, 2);
INSERT INTO task_details(start_time, end_time, duration, description, is_active, project_id, task_id, category_id) VALUES('12:15:00', '15:05:00', '02:50:00', 'Implementing back-end component of user login input, adding validations, persisting to database and end-to-end testing', 1, 2, ?, 2);
