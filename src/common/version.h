...
#define TASKABLE_MINOR 98
#define TASKABLE_PATCH 6
...
#define TASKABLE_FILE_VERSION TASKABLE_MAJOR, TASKABLE_MINOR, TASKABLE_PATCH

#define FILE_VERSION_STR STRINGIFY(TASKABLE_MAJOR) \
                         "." STRINGIFY(TASKABLE_MINOR) \
                         "." STRINGIFY(TASKABLE_PATCH)

#define PRODUCT_VERSION TASKABLE_FILE_VERSION
